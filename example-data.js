...
Ext.onReady(function() {
    ...
    window.generateData = function(n, floor){
        ...
        for (i = 0; i < (n || 12); i++) {
            data.push({
                ...
                pod1: Math.floor(Math.max((Math.random() * 100), floor)),
                pod2: Math.floor(Math.max((Math.random() * 100), floor)),
                pod3: Math.floor(Math.max((Math.random() * 100), floor)),
    ...
    window.generateDataNegative = function(n, floor){
        ...
        for (i = 0; i < (n || 12); i++) {
            data.push({
                name: Ext.Date.monthNames[i % 12],
                pod1: Math.floor(((Math.random() - 0.5) * 100), floor),
                pod2: Math.floor(((Math.random() - 0.5) * 100), floor),
                pod3: Math.floor(((Math.random() - 0.5) * 100), floor),
    ...
    window.store1 = Ext.create('Ext.data.JsonStore', {
        fields: ['name', 'pod1', 'pod2', 'pod3', 'data4', 'data5', 'data6', 'data7', 'data9', 'data9'],
        data: generateData()
    });
